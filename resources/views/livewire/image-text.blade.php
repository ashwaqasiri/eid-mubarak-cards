<div>
  <div class="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0">
    ...
    <!--Main Col-->
    <div id="profile" class="w-full lg:w-3/5 rounded-lg lg:rounded-r-lg lg:rounded-l-none shadow-2xl bg-white opacity-75 mx-6 lg:mx-0">
    

        <div class="p-4 md:p-12 text-center lg:text-right">
            <!-- Image for mobile view style="background-image: url('img/eid-1.jpg');"-->
            <img src="{!! ($base64 ? $base64 : 'img/eid-1.jpg') !!}" class="block lg:hidden rounded-lg shadow-xl mx-auto -mt-16 h-64 w-64 bg-cover bg-center">
            
            <input wire:model='name' class="text-3xl font-bold pt-8 lg:pt-0 lg:text-center appearance-none bg-transparent border-none w-full text-gray-700 mr-3 py-1 px-2 leading-tight focus:outline-none" type="text" placeholder="اسمك" aria-label="Full name">
    ...
    <!--Img Col-->
    <div class="invisible lg:visible w-full lg:w-2/5">
        <!-- Big profile image for side bar (desktop)-->
        <img src="{!! ($base64 ? $base64 : 'img/eid-1.jpg') !!}" class="rounded-none lg:rounded-lg shadow-2xl" style="height: 600px;">
        <!-- Image from: http://unsplash.com/photos/MP0IUfwrn0A {{URL::asset('img/eid-1.jpg')}}" -->
