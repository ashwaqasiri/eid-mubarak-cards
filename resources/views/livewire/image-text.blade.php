<div>
    <div class="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0">
        ...
        <!--Main Col-->
        <div id="profile"
            class="w-full lg:w-3/5 rounded-lg lg:rounded-r-lg lg:rounded-l-none shadow-2xl bg-white opacity-75 mx-6 lg:mx-0">
            <div class="p-4 md:p-12 text-center lg:text-right">
                <!-- Image for mobile view"-->
                <img src="{!! $base64 ? $base64 : 'img/eid-1.jpg' !!}"
                    class="block lg:hidden rounded-lg shadow-xl mx-auto -mt-16 h-64 w-64 bg-cover bg-center">
                ...
                <div class="pt-12 pb-8">
                    <a href="{!! $base64 ? $base64 : 'img/eid-1.jpg' !!}" download="eidmubarak.jpg"
                        ...
                        style="background-color: #c79a69">
                        تحميل
                    </a>
                </div>

                <div class="mt-6 pb-16 lg:pb-0 w-4/5 lg:w-full mx-auto flex flex-wrap items-center justify-start">
                    <a class="link ml-6" href="https://github.com/ashwaqasiri/" data-tippy-content="github"><svg
                    ...
                    <a class="link" href="https://ashwaqasiri.netlify.app/" data-tippy-content="website"><svg
                            class="h-6 fill-current text-gray-600 hover:text-green-700" role="img" viewBox="0 0 24 24"
                            xmlns="http://www.w3.org/2000/svg">
                            <title>Website</title>
                            <path
